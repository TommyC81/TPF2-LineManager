  ...
  return {
    en = {
      ...
      Description = 'A mod to automatically manage the number of buses on bus lines.\n'
                 ...
                 .. 'This mod can be added/removed to new and existing games as desired.\n'
				 .. '\n'
				 .. 'Quick start:\n'
				 .. '1. Create a bus line.\n'
				 ...
				 .. '* When a vehicle is sold, it well sell the oldest vehicle on the line. The mod will ensure there is at least 1 vehicle remaining on a line.\n'
				 .. '\n'
				 .. 'Troubleshooting and what the mod does NOT do:\n'
				 .. '* This mod will not fix poorly designed transports networks. If you have a bus line that has highly uneven demand along the route, you will have to fix that yourself - there is no software that can fix this for you.\n'
				 .. '* If no vehicles are added despite a single station being overloaded along the route - it is probably a sign of poor route design, split the route up into evenly balanced (demand) sections.\n'
				 .. '\n'
				 .. 'Untested:\n'
