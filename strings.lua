  ...
  return {
    en = {
      ...
      Description = 'A mod to automatically manage the number of buses/trams on passenger lines.\n'
                 .. '\n'
                 .. 'Taking into account the loadfactor over time, and demand on the line, this mod will buy/sell buses/trams accordingly.\n'
				 ...
				 .. '3. Make sure a depot is accessible for the buses/trams on the passenger lines.\n'
				 .. '4. Make sure you have cash available for buying buses/trams (when the mod determines it required).\n'
				 .. '\n'
				 .. 'What the mod does:\n'
				 ...
				 .. 'Thus, performance impact should be negligble. This has not been studies in-depth, but no effect of the sampling/updates has been observed in games with hundreds of lines/buses/trams.\n'
				 .. '\n'
				 .. 'Untested:\n'
