  ...
  return {
    en = {
      ...
      Description = 'A mod to automatically manage the number of buses/trams/aircraft/ships on passenger lines.\n'
				 ...
				 .. '2. Add one bus/tram to the bus/tram/aircraft/ship line.\n'
				 ...
				 .. '\n'
				 .. 'Known stuff:\n'
				 .. '* Until someone can suggest a reasonable way to locate available depots, the mod makes use of sending an existing vehicle to a depot to see if one is available - the depot order is immediately cancelled if succesful, however, the temporary depot order still empties the vehicle.\n'
				 .. '* Although a reasonable amount of effort has been spent on testing the buying/selling logic to avoid having vehicles regularly bought/sold on lines that are on the boundary of capacity/demand/rate, it may still occur. The smaller capacity vechicle used on a line will more easily allow a balanced/optimized number of vehicles on that line.\n'
				 .. '\n'
				 .. 'Untested:\n'
