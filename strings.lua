  ...
  return {
    en = {
      ...
      Description = 'A mod to automatically manage the number of buses/trams/aircraft/ships on passenger lines.\n'
				 ...
				 .. '\n'
				 .. 'Quick start:\n'
				 .. '1. Create a bus/tram/aircraft/ship line.\n'
				 .. '2. Add one bus/tram/aircraft/ship to the bus/tram/aircraft/ship line.\n'
				 .. '3. Make sure a depot is accessible for the bus/tram/aircraft/ship on the line.\n'
				 ...
				 .. '* This mod will not fix poorly designed transports networks. If you have a bus/tram/aircraft/ship line with highly uneven demand along the route, you will have to fix that yourself - there is no software that can fix this for you.\n'
				 ...
				 .. '\n'
				 .. 'Untested:\n'
				 .. '* If there is not enough cash available to add/buy a bus/tram/aircraft/ship to a line - not sure what will happen, but assume a silent failure.\n'
				 .. '* If a vehicle type is no longer available (old) when it is time to add/buy a bus/tram/aircraft/ship - not sure what will happen, but assume a silent failure.\n'
				 .. '\n'
				 .. 'Future plans:\n'
