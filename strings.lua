  ...
  return {
    en = {
      ...
      Description = 'A mod to automatically manage the number of buses on bus lines.\n'
				 ...
				 .. 'Thus, performance impact should be negligble. This has not been studies in-depth, but no effect of the sampling/updates has been observed in games with hundreds of lines/buses.\n'
				 .. '\n'
				 .. 'Untested:\n'
