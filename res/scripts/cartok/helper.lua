...
--      [4]  = 0, BUS (BUS)
--      [5]  = 0, TRUCK (TRUCK)
--      [6]  = 0, TRAM (STEAM_TRAM/HORSE_TRAM PAX and CARGO)
--      [7]  = 0, ELECTRIC_TRAM (ELECTRIC_TRAM PAX and CARGO)
--      [8]  = 0, TRAIN (STEAM_TRAIN)
--      [9]  = 0, ELECTRIC_TRAIN (ELECTRIC_TRAIN)
--      [10] = 0, AIRCRAFT
--      [11] = 0, SHIP (WATER_LARGE)
--      [12] = 0, SMALL_AIRCRAFT (PLANE_SMALL_PAX)
--      [13] = 0, SMALL_SHIP (WATER_SMALL)
--      [14] = 0,
--      [15] = 0,
--      [16] = 0,
--    },
