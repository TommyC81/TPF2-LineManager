...
local function gui_initNotificationWindow()
    ...
    notification_text = notification_text .. "\n"
    notification_text = notification_text .. "Note specifically that LineManager uses square brackets to set manual line rules i.e. '[' and ']'.\n"
    notification_text = notification_text .. "\n"
    notification_text = notification_text .. "By default, all automatic line management is enabled - you can disable settings as required in the LineManager settings. Depending on your preference and type of game, you may prefer to enable automatic line management for some/all types of lines, or only use manually assigned rules, or a combination thereof. There is no right or wrong.\n"
    notification_text = notification_text .. "\n"
